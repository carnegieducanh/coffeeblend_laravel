      ...
      <div class="col-md-6">
        ...
        <div style="max-height: 440px; overflow-y: auto; padding-right: 8px;">
          ...
          <a href="{{ route('product.single', $dessert->id) }}" class="pricing-entry d-flex ftco-animate"
            ...
            <div class="img"
              style="background-image: url({{ str_starts_with($dessert->image, 'http') ? $dessert->image : asset('assets/images/'.$dessert->image) }});">
            </div>
            <div class="desc pl-3">
      ...
      <div class="col-md-6">
        ...
        <div style="max-height: 440px; overflow-y: auto; padding-right: 8px;">
          ...
          <a href="{{ route('product.single', $drink->id) }}" class="pricing-entry d-flex ftco-animate"
            style="text-decoration: none; color: inherit; cursor: pointer;">
            <div class="img"
              style="background-image: url({{ str_starts_with($drink->image, 'http') ? $drink->image : asset('assets/images/'.$drink->image) }});">
            </div>
            <div class="desc pl-3">
              <div class="d-flex text align-items-center">
          ...
          <div class="col-md-12 d-flex align-items-center">
            ...
            <div class="tab-content ftco-animate" id="v-pills-tabContent">
              ...
              <div class="tab-pane fade show active" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-2-tab">
                <div class="row">
                  @foreach ($drinks->take(6) as $drink)
              ...
              <div class="tab-pane fade" id="v-pills-3" role="tabpanel" aria-labelledby="v-pills-3-tab">
                <div class="row">
                  @foreach ($desserts->take(6) as $dessert)
                  <div class="col-md-4 text-center d-flex">
                    <div class="menu-wrap w-100 d-flex flex-column">

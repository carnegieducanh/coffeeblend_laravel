    ...
    <div class="container">
      <div class="row slider-text justify-content-center align-items-center">
        ...
        <div class="col-md-7 col-sm-12 text-center ftco-animate">
          ...
          <p class="breadcrumbs"><span class="mr-2"><a href="{{ route('home') }}">Home</a></span> <span>Pay with
              PayPal</span>
          </p>
        </div>
...
<div class="container">
  ...
  <script
    src="https://www.paypal.com/sdk/js?client-id=AelpqitkucAGCES2od7HNr-7T87Uar97QHeezeFLMFdLMPQDAFA7CWxYQFS8lWY0k0az8mvvaR0QNwKk&currency=USD">
  </script>
